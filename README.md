...
- 🆕 We have proposed Segment Any Anomaly without Training via Hybrid Prompt Regularizati [arxiv](https://arxiv.org/abs/2305.10724). The code will be released soon~
